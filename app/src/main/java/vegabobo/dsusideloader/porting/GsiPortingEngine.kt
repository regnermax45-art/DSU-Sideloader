...
class GsiPortingEngine(
    ...
    // Components
    private val systemExtractor = SystemExtractor(session, storageManager)
    private val patchingFramework = PatchingFramework(session, storageManager)
    private val imageMerger = ImageMerger(session, storageManager)
